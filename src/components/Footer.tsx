    ...
    return (
      <footer role="contentinfo" className="site-footer">
        <div className="max-w-7xl mx-auto px-6 py-10 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            <div className="flex items-center gap-3">
              <svg width="24" height="24" viewBox="0 0 24 24" aria-hidden="true" className="shrink-0">
                <path d="M4.5 7.5 12 3l7.5 4.5v9L12 21l-7.5-4.5v-9Z" className="fill-transparent stroke-secondary" strokeWidth="1.25"/>
                <path d="M12 3v18M4.5 7.5 12 12l7.5-4.5" className="stroke-secondary" strokeWidth="1.25" fill="none"/>
              </svg>
              <div className="footer-wordmark">LEM-BOX</div>
            </div>
            <p className="mt-2 body-small">
              Gestión integral desde Miami: una salida semanal hacia Argentina y logística para tu e-commerce en EE. UU.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="mt-2 space-y-1 text-sm">
              ...
              <li>
                <address className="not-italic meta" itemScope itemType="http://schema.org/PostalAddress">
          ...
          {/* Legales */}
          <div>
            <div className="footer-heading">Legales</div>
            <ul className="mt-2 space-y-1 text-sm">
              <li>
                <a href="/privacidad" className="link-quiet fx transition-colors duration-200">
                  Política de Privacidad
                </a>
              </li>
              <li>
                <a href="/terminos" className="link-quiet fx transition-colors duration-200">
        ...
        <div className="border-t border-brandborder">
          <div className="max-w-7xl mx-auto px-6 py-4 legal-note text-center">
            <div className="block sm:hidden leading-relaxed">
              © {new Date().getFullYear()} LEM-BOX. Todos los derechos reservados.<br />
              Made with 💻 by <a href="https://devrodri.com" target="_blank" rel="noopener noreferrer" className="link-quiet fx transition-colors duration-200">Rodrigo Opalo</a>
            </div>
            <div className="hidden sm:block">
              © {new Date().getFullYear()} LEM-BOX. Todos los derechos reservados. · Made with 💻 by <a href="https://devrodri.com" target="_blank" rel="noopener noreferrer" className="link-quiet fx transition-colors duration-200">Rodrigo Opalo</a>
            </div>
          </div>
        </div>
      </footer>
